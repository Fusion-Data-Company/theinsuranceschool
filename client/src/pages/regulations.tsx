...
import { Search, Filter, Building, Phone, MapPin, Clock, BookOpen, FileText, AlertTriangle, CheckCircle, Award } from "lucide-react";
    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="text-sm text-gray-700 bg-indigo-50 p-3 rounded-lg">
            {stateData.keyStatutes}
          </div>
        </div>
        ...
        <div className="pt-4 border-t border-gray-200">
          <div className="text-xs text-gray-500">
            <strong>Sources:</strong> {stateData.sources}
          </div>
        </div>
      </div>
    </div>
