...
const DEFAULT_WORDS = ["INSURANCE", "SCHOOL", "RECRUITING", "ANNEX"]

export function ParticleTextEffect({ words = DEFAULT_WORDS, className = "", width = 800, height = 200 }: ParticleTextEffectProps) {
  ...
  const nextWord = (word: string, canvas: HTMLCanvasElement) => {
    ...
    // Draw text exactly like the demo
    const fontSize = Math.min(width / word.length * 1.5, height * 0.6)
  ...
  const animate = () => {
    ...
    // Background with motion blur like demo
